...
public partial class NNewStudent : System.Web.UI.Page
{
    ...
    protected void btnRegister1_Click(object sender, EventArgs e)
    {
        ...
        {
            DateTime DOB = Convert.ToDateTime(DrpMM.SelectedItem.Text + " " + DrpDD.SelectedItem.Text + " " + DrpYY.SelectedItem.Text);
            int a = Sadapter.Insert(txtSErNo.Text, txtSfname.Text, txtSLname.Text, txtSadd.Text, txtScity.Text, txtSstate.Text, txtSpin.Text, DOB, DrpGender.SelectedItem.ToString(), txtSMoNo.Text, txtSeid.Text, txtSUname.Text, txtSpass.Text);
